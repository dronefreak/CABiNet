...
Semantic segmentation results on the UAVid (Lyu et al., 2020) validation set shown below. First row consists of the input RGB images. Second row contains the predictions from our model and the third row shows the ground truth of t.he input images.
