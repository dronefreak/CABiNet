...
root = Path(
    "/home/neural_debugger/Downloads/datasets/AeroScapes/AeroScapes-YOLO/images/train"
)  # <-- change to your converted AeroScapes train images folder
