...
# Per-dataset constructor kwargs. UAVid/AeroScapes consume a pre-converted
# images/+masks/ directory (see convert_uavid_to_yolo.py /
# convert_aeroscapes_to_yolo.py) and no longer need a colour-palette
